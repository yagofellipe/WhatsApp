...
import com.yagofellipe.whatsapp.databinding.ActivityPerfilBinding
import com.yagofellipe.whatsapp.utils.exibirMensagem

class PerfilActivity : AppCompatActivity() {

    private val binding : ActivityPerfilBinding by lazy {
    ...
    private val gerenciadorGaleria = registerForActivityResult(
        ...
        if(uri != null){
            ...
            exibirMensagem("Nenhuma imagem foi selecionada")
        }
    }
            ...
            firestore
                ...
                .addOnSuccessListener{documentSnapshot ->
                    ...
                    if (dadosUsuarios != null){
                        ...
                        binding.ediNomePerfil.setText(nome)
                        if (foto.isNotEmpty()){
                            Picasso.get()
                                .load(foto)
    ...
    private fun inicializarEventosClique() {
        ...
        binding.btnSalvarPerfil.setOnClickListener{
            val nomeUsuario = binding.ediNomePerfil.text.toString()
            ...
            if (nomeUsuario.isNotEmpty()){
                ...
                exibirMensagem("Preencha nome para atualizar")
            }
        }
    }
